...
We have 2 primary "standard" layouts - one for content that is included in a Guide and one for content that is not.
...
* Get legal help application block
* Sponsored by block(s), when the content is tagged to a sponsored library section
* Learn more block. The learn more block is populated by the recommendations field
